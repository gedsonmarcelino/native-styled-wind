export default {
  ...
  "rounded-s": "border-start-start-radius:  4px; border-end-start-radius:  4px",
  "rounded-s-md":
  ...
  "rounded-e-sm": "border-start-end-radius:  2px; border-end-end-radius:  2px",
  "rounded-e": "border-start-end-radius:  4px; border-end-end-radius:  4px",
  "rounded-e-md": "border-start-end-radius:  6px; border-end-end-radius:  6px",
  "rounded-e-lg": "border-start-end-radius:  8px; border-end-end-radius:  8px",
  "rounded-e-xl":
